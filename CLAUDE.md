...
Дальше (следующая сессия): **подготовка к релизу**, начать с Flatpak-манифеста
(`--socket=ssh-auth`, Flathub — основной канал Linux), затем .deb/.rpm, MSI + ZIP, DMG,
README со скриншотами, проверка обновлений через GitHub Releases API. Отложенные пункты
(Mosh, локальная AI-модель, планшетный режим) — не предлагать. Актуальный статус — в `memory/`.
